...
export const SearchBar = ({ 
  ...
  return (
    <div className={`relative px-4 flex items-center justify-between gap-2 w-full max-w-full overflow-hidden ${variant === 'full' ? 'px-0 py-0.5 min-h-[48px]' : 'py-2 min-h-[70px]'}`}>
